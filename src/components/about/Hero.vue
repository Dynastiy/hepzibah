<template>
    <section
      class="bg-center bg-cover bg-no-repeat bg-[url('https://www.shutterstock.com/shutterstock/videos/1106748331/thumb/7.jpg?ip=x480')] bg-gray-600 bg-blend-multiply"
    >
